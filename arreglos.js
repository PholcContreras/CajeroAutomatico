...
if(state_login1){
    const final_state1 = state_login1 ? "Bienvenida Mali"  : "Error!" ;
    ...
    const final_state2 = state_login2 ? "Bienvenida Gera"  : "Error!" ;
    ...
    const final_state3 = state_login3 ? "Bienvenida Maui"  : "Error!" ;
         ...
         var Cantidad1=parseInt(document.getElementById("C1").value);
           ...
           if(CantidadTotal>=10 &&CantidadTotal<=990 ){
            ...
            if (Cantidad1<=700){
                ...
                response2.innerHTML = template ("Depocito aceptado");
        }}
     else { 
        var result1 = response2.innerHTML = template ("Error! Depocite una cantidad más pequeña");
...
bt2.addEventListener("click",function(event){
    ...
    if(CantidadTotal>=10 &&CantidadTotal<=990 ){
        ...
        response3.innerHTML = template ("Retiro aceptado");}
    else { 
